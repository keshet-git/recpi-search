...
IDS = {-1}
App_ID = "3c29f155"
App_KEY = "51273edd95cf3efae15a13d9c5a3efe3"
URL = f'https://api.edamam.com/search?/app_id=${App_ID}&app_key=${App_KEY}'
...
def main():
    ...
    while command.lower() != 'q':
        ...
        output = ""
        for x in foodCategory:
            output += food_category_mapping.get(x, "!") + " "
        health = (((
            '''
...
def query_recipes():
    ...
    index = 0
    while not success:
        key_word = input("f' (foodCategory) + (output2)")
